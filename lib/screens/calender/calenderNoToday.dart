...
class MyCalenderNoToday extends StatelessWidget {
  const MyCalenderNoToday({Key? key}) : super(key: key);
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              MaterialButton(
                                onPressed: ()async{
                                  if(DateTime.now().weekday != 1){
                                    BlocProvider.of<NoToday>(context).setStr(DateTime.now().add(Duration(days: 8 - DateTime.now().weekday)));
                                  }else{
                                    BlocProvider.of<NoToday>(context).setStr(DateTime.now());
                                  }
                                  await Future.delayed(const Duration(milliseconds: 50));
                              ...
                              MaterialButton(
                                onPressed: ()async{
                                  if(DateTime.now().weekday != 1){
                                    BlocProvider.of<NoToday>(context).setStr(DateTime.now().add(Duration(days: 9 - DateTime.now().weekday)));
                                  }else{
                                    BlocProvider.of<NoToday>(context).setStr(DateTime.now());
                                  }
                                  await Future.delayed(const Duration(milliseconds: 50));
                              ...
                              MaterialButton(
                                onPressed: ()async{
                                  BlocProvider.of<NoToday>(context).setStr(DateTime.now().add(const Duration(days: 7)));
                                  await Future.delayed(const Duration(milliseconds: 50));
                                  Navigator.of(context).pop();
                                },
                                color: MyColor.mainLight,
                          ...
                          SizedBox(
                            ...
                            child: TableCalendar(
                              ...
                              onDaySelected: (selectedDay, focusedDay) {
                                BlocProvider.of<NoToday>(context).setStr(focusedDay);
                              },
                            ),
                          ),
